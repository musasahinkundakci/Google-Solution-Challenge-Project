...
const AddCategory = ({ getCategories, ...props }) => {
    ...
    return (
        <div><div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Startup Name</label>
            <input ref={nameRef} type="text" class="form-control" id="exampleFormControlInput1" placeholder="Startup name" />
        </div><div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Description</label>
                <input ref={descriptionRef} type="text" class="form-control" id="exampleFormControlInput1" placeholder="..." />
            </div>
            <button className='btn btn-danger' onClick={clickHandler}>Send</button></div>
    )
}
