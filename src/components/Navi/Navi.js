        ...
        <div>
            <nav class="navbar navbar-expand-lg navbar-light bg-light rounded-5 px-3 mt-4">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#"><img style={{ width: "3rem" }} src="https://cdn2.hubspot.net/hubfs/53/image8-2.jpg" /></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <Link to="/categories" class="nav-link" >Üniversite Startupları</Link>
                            </li>
                            <li class="nav-item">
                                <Link to="/investors" class="nav-link" >Yatırımcılar</Link>
                            </li>
